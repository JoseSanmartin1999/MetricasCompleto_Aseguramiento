...
import { iso25022Data, calculateCharacteristicScore, getScoreInterpretation, getTotalQuestions } from '../data/iso25022';
import './ISO25022Evaluator.css';

function ISO25022Evaluator({ onGeneratePDF }) {
    const [responses, setResponses] = useState({});
    const [activeCharacteristic, setActiveCharacteristic] = useState('efectividad');
    ...
    const calculateOverallScore = () => {
        const characteristics = Object.values(iso25022Data);
        let totalScore = 0;
    ...
    const getCharacteristicScore = (characteristicId) => {
        const char = iso25022Data[characteristicId];
        const charResponses = {};
    ...
    const activeChar = iso25022Data[activeCharacteristic];
    ...
    return (
        <div className="iso-evaluator iso22-evaluator">
            {/* Header de Evaluación */}
            <div className="eval-header eval-header-22">
                <div className="eval-header-content">
                    <div>
                        <h2>🎯 Evaluación ISO 25022</h2>
                        <p>Medición de Calidad en Uso - Perspectiva del Usuario Final</p>
                    </div>
            ...
            {/* Información sobre ISO 25022 */}
            <div className="iso22-info-banner">
                <div className="info-icon">
                    <i className="fas fa-info-circle"></i>
                </div>
                <div>
                    <h3>Sobre ISO 25022</h3>
                    <p>Este estándar mide la <strong>calidad en uso</strong> del software, evaluando cómo los usuarios reales experimentan el sistema en contextos específicos. Se centra en efectividad, eficiencia, satisfacción, ausencia de riesgo y cobertura del contexto.</p>
                </div>
            </div>

            {/* Pestañas de Características */}
            <div className="characteristics-tabs characteristics-tabs-22">
                {Object.values(iso25022Data).map((char) => {
            ...
            {getAnsweredQuestions() > 0 && (
                <div className="results-panel">
                    <div className="overall-score">
                        ...
                        <div>
                            <h3>Calidad en Uso Global</h3>
                            <p>Evaluación general de la experiencia del usuario según ISO 25022</p>
                        </div>
                    </div>
                    ...
                    {isComplete() && (
                        <button
                            ...
                            onClick={() => onGeneratePDF && onGeneratePDF({
                                ...
                                overallScore,
                                interpretation,
                                characteristicScores: Object.keys(iso25022Data).map(id => ({
                                    ...iso25022Data[id],
...
export default ISO25022Evaluator;
